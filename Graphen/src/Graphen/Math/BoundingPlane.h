...
namespace Math
{
    ...
    public:
        ...
        friend BoundingPlane operator* (const BoundingPlane& plane, const OrthogonalTransform& xform )
        {
        ...
        friend BoundingPlane operator* (const BoundingPlane& plane , const Matrix4& mat)
        {
